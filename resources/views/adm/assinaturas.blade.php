                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                @foreach ($assinaturas as $assinatura)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4">
                                            {{ AnunciosModel::where('id', $assinatura->id_anuncio)->first()->titulo_anuncio ?? '' }}
                                        </td>
                                        <td class="px-6 py-4">
                                            {{ $assinatura->days }}
                                        </td>
                                        ...
                                        <td class="px-6 py-4">
                                            {{ date('d/m/Y H:i', strtotime($assinatura->exprires))  }}
                                        </td>
                                        
                                        <td class="px-6 py-4">
                                            <form action="{{ route('assinaturas.destroy',$assinatura->id) }}" method="POST">
                            
                                            <a class="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="{{ route('assinaturas.show',$assinatura->id) }}">Show</a>
                                
                                            <!-- <a class="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="{{ route('assinaturas.edit',$assinatura->id) }}">Edit</a> -->
