                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                @foreach ($mercados as $mercado)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4">
                                            {{ date('d/m/Y H:i', strtotime($mercado->updated_at)) ?? date('d/m/Y H:i', strtotime($mercado->created_at))  }}
                                        </td>
                                        
                                        <td class="px-6 py-4">
                                             
                                            <!-- <a class="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="{{ route('mercadopago.show',$mercado->id) }}">Show</a> -->
                                
                                            <a class="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="{{ route('mercadopago.edit',$mercado->id) }}">Edit</a>
