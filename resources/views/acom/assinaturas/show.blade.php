                    ...
                    >
                      <h3 class="font-semibold text-lg text-blueGray-700">
                        ...
                        <div class="pull-right">
                            <a class="bg-transparent float-right hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" href="{{ url('acompanhantes/meus-planos') }}"> Voltar</a>
                        </div>
                    </div>
                  </div>
                </div>
