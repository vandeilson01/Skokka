                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                @foreach ($planos as $plano)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4">
                                            {{ date('d/m/Y H:i', strtotime($plano->updated_at)) ?? date('d/m/Y H:i', strtotime($plano->created_at))  }}
                                        </td>
                                        
                                        <td class="px-6 py-4">
                                            <form action="{{ route('planos.destroy',$plano->id) }}" method="POST">
                            
                                            <a class="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="{{ route('planos.show',$plano->id) }}">Show</a>
